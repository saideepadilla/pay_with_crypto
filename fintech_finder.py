...
#This part imports the fuctions that allow us to pull accounts from a wallet and pay
...
# function to calcuate the wage note similar to others
...
# These are functions to be placed in the side bar. 
